      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          ...
          <div className="flex items-center mb-8">
            ...
            <span className="text-xl font-bold text-gray-900">Vehicle Tracker</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                placeholder={isLogin ? "seller@company.com" : "Enter your email"}
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={isLogin ? "Sellstore." : "Enter your password"}
                />
                <button
                  type="button"
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-6 border border-white border-opacity-20">
            <div className="bg-white bg-opacity-20 rounded-lg p-4 mb-4">
              ...
              <div className="text-left">
                ...
                <div className="text-blue-100 text-sm">Active Transactions</div>
              </div>
            </div>
              ...
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="flex items-center justify-between bg-white bg-opacity-10 rounded-lg p-3">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-blue-100 text-xs">Fuel</div>
                  </div>
                </div>
              ))}
            </div>
